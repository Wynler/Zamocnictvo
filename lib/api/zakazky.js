  ...
  try {
    ...
    const zakazkySEtapami = (zakazkyData || []).map((zakazka) => ({
      ...
      etapy: (zakazka.etapy || []).map((etapa) => ({
        ...
        zelanyStartVyroby: etapa.datum_zaciatku,
        datumMaterialu: etapa.datum_materialu,
        montazDni: etapa.montaz_dni,
        zinkovanieDni: etapa.zinkovanie_dni,
        farbaDni: etapa.farba_dni,
        pieskovanie: etapa.pieskovanie,
        pieskovanieDni: etapa.pieskovanie_dni,
