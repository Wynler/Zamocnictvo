...
export function naplanujCasti(casti, { etapaClovekohod, sumaHmotnostiEtapy, etapaPocetLudi, etapaStart }) {
  ...
  for (const c of casti) {
    ...
    // Ďalšia časť môže začať až nasledujúci pracovný deň po tejto —
    // rovnaká čata nemôže tú istú prácu aj skončiť aj začať niečo nové v ten istý deň.
    predchadzajuciKoniec = koniec !== null ? pridajPracovneDni(koniec, 1) : null;
  }
